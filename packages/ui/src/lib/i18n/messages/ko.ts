...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.executionTarget.label': '실행 대상',
  'chat.executionTarget.openCode': 'OpenCode',
  'chat.executionTarget.codex': 'Codex',
  'chat.executionTarget.codexUnavailable': '이 런타임에서는 Codex를 사용할 수 없습니다.',
  'chat.executionTarget.codexUnsupportedPayload': '현재 Codex는 텍스트 프롬프트만 지원합니다.',
  'common.loading': '로딩 중...',
