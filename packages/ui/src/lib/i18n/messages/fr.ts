...
export const dict = {
  ...
  'chat.executionTarget.label': 'Cible d’exécution',
  'chat.executionTarget.openCode': 'OpenCode',
  'chat.executionTarget.codex': 'Codex',
  'chat.executionTarget.codexUnavailable': 'Codex n’est pas disponible dans cet environnement.',
  'chat.executionTarget.codexUnsupportedPayload': 'Codex ne prend actuellement en charge que les invites textuelles.',
