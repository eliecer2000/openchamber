...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.executionTarget.label': 'Destino de execução',
  'chat.executionTarget.openCode': 'OpenCode',
  'chat.executionTarget.codex': 'Codex',
  'chat.executionTarget.codexUnavailable': 'O Codex não está disponível neste ambiente.',
  'chat.executionTarget.codexUnsupportedPayload': 'No momento, o Codex aceita apenas prompts de texto.',
