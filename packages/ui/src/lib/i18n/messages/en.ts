...
export const dict = {
  ...
  'chat.executionTarget.label': 'Execution target',
  'chat.executionTarget.openCode': 'OpenCode',
  'chat.executionTarget.codex': 'Codex',
  'chat.executionTarget.codexUnavailable': 'Codex is unavailable in this runtime.',
  'chat.executionTarget.codexUnsupportedPayload': 'Codex currently supports text prompts only.',
