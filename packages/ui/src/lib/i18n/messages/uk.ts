...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.executionTarget.label': 'Ціль виконання',
  'chat.executionTarget.openCode': 'OpenCode',
  'chat.executionTarget.codex': 'Codex',
  'chat.executionTarget.codexUnavailable': 'Codex недоступний у цьому середовищі.',
  'chat.executionTarget.codexUnsupportedPayload': 'Наразі Codex підтримує лише текстові запити.',
