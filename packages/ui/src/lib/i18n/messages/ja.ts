...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.executionTarget.label': '実行ターゲット',
  'chat.executionTarget.openCode': 'OpenCode',
  'chat.executionTarget.codex': 'Codex',
  'chat.executionTarget.codexUnavailable': 'このランタイムでは Codex を利用できません。',
  'chat.executionTarget.codexUnsupportedPayload': '現在、Codex はテキストプロンプトのみ対応しています。',
