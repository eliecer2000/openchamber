...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.executionTarget.label': 'Destino de ejecución',
  'chat.executionTarget.openCode': 'OpenCode',
  'chat.executionTarget.codex': 'Codex',
  'chat.executionTarget.codexUnavailable': 'Codex no está disponible en este entorno.',
  'chat.executionTarget.codexUnsupportedPayload': 'Actualmente, Codex solo admite mensajes de texto.',
